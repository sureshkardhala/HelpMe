...
<!-- 
	...
	<input class="input-box" type="text" name="display_name" required value="<?php echo $row['display_name']; ?>">
	</div>

    <div class="box"> 
	<label>Mobile No (Optional)</label><br><br/>
	<input class="input-box" type="text" name="phone" required value="<?php echo $row['phone']; ?>">
    </div>

    <div class="box"> 
	<label>Profession</label><br><br/>
	<input class="input-box" type="text" name="profession" required value="<?php echo $row['profession']; ?>">
    </div>
	...
	<input class="input-box" type="text" name="education" required value="<?php echo $row['education']; ?>">
    </div>
	...
	<textarea class="textarea-max" type="text" name="about" id="about" required value="<?php echo $row['about']; ?>"><?php echo $row['about']; ?></textarea>
    </div>

    <div class="box"> 
	 <label>Achievements</label><br><br/>
	<textarea class="textarea-min" type="text" name="achievements" id="achievements" required value="<?php echo $row['achievements']; ?>"><?php echo $row['achievements']; ?></textarea>
    </div>

    <div style="border: 1px solid pink;">
    <label style="padding: 10px;">Social Media Links</label><hr>
    <span style="display: flex;padding: 10px;"><p style="width: 80px";>Instagram</p><input class="input-box" type="text"></span>
    <span style="display: flex;padding: 10px;"><p style="width: 80px";>Linked In</p><input class="input-box" type="text"></span>
    <span style="display: flex;padding: 10px;"><p style="width: 80px";>Website</p><input class="input-box" type="text"></span>
    <span style="display: flex;padding: 10px;"><p style="width: 80px";>Git Hub</p><input class="input-box" type="text"></span>
    </div>
