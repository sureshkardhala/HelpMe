...
function createPost($request_values)
	{
		...
		if (count($errors) == 0) {
			...
			$query = "INSERT INTO posts (user_id, username, title, slug, image, body, published, created_at, updated_at) VALUES($current_user, '$username', '$title', '$post_slug', '$featured_image', '$body', $published, now(), now())";
			var_dump($query);
